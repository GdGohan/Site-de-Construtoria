        ...
        <div class="container">
            <div class="header-content">
                <div class="logo">
                    ...
                    <span class="logo-text">Campos</span>
                </div>
            ...
            <div class="contact-grid">
                <div class="contact-info">
                    ...
                    <div class="info-card">
                        ...
                        <h3>E-mail</h3>
                        <a href="mailto:contato@campos.com.br">contato@campos.com.br</a>
                    </div>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; <span id="currentYear"></span> Campos. Todos os direitos reservados.</p>
            </div>
        </div>
    </footer>
